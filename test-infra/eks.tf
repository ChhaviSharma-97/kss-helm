...
module "eks_cluster" {
  ...
  cluster_version = try(local.workspace.eks_cluster.version, "1.25")
  ...
  self_managed_node_groups = {
    ...
    default_node_group = {
      ...
      min_size     = try(local.workspace.eks_cluster.min_size, 1)
      desired_size = try(local.workspace.eks_cluster.min_size, 1)
      max_size     = try(local.workspace.eks_cluster.max_size, 2)
      tags = {
